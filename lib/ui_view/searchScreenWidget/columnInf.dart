...
class ColumnInf extends StatefulWidget {
  final AnimationController? animationController;
  final Animation<double>? animation;

  ColumnInf({Key? key, this.animationController, this.animation})
      : super(key: key);

  @override
  State<ColumnInf> createState() => _ColumnInfState();
}

class _ColumnInfState extends State<ColumnInf> {
  List imgList = [];
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                      image: NetworkImage(widget.imgAsset![0]), fit: BoxFit.cover)),
              child: Container(
