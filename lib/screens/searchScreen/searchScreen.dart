...
class OnlineTvSearchPage extends StatefulWidget {
  const OnlineTvSearchPage({Key? key, this.animationController})
      : super(key: key);

  final AnimationController? animationController;
  @override
  _OnlineTvSearchPageState createState() => _OnlineTvSearchPageState();
}

class _OnlineTvSearchPageState extends State<OnlineTvSearchPage>
