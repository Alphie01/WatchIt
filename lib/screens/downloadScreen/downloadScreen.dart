...
import 'package:theme_templates/ui_view/downloadPageWidget/downloadedContents.dart';
import 'package:theme_templates/ui_view/downloadPageWidget/smartDownload.dart';
...
class OnlineTvDownloadPage extends StatefulWidget {
  const OnlineTvDownloadPage({Key? key, this.animationController})
      : super(key: key);

  final AnimationController? animationController;
  @override
  _OnlineTvDownloadPageState createState() => _OnlineTvDownloadPageState();
}

class _OnlineTvDownloadPageState extends State<OnlineTvDownloadPage>
