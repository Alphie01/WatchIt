...
class OnlineTvInfoPage extends StatefulWidget {
  final String? watchname;
  final List? watchimgs;
  final String? watchdesc;
  const OnlineTvInfoPage(
      {Key? key,
  ...
  @override
  _OnlineTvInfoPageState createState() => _OnlineTvInfoPageState();
}

class _OnlineTvInfoPageState extends State<OnlineTvInfoPage>
