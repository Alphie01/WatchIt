...
import 'package:theme_templates/ui_view/collectionPageWidget/collectionHeader.dart';
import 'package:theme_templates/ui_view/collectionPageWidget/collectionQue.dart';
import 'package:theme_templates/ui_view/collectionPageWidget/collectionWatchList.dart';
...
class OnlineTvCollectionPage extends StatefulWidget {
  const OnlineTvCollectionPage({Key? key, this.animationController})
      : super(key: key);

  final AnimationController? animationController;
  @override
  _OnlineTvCollectionPageState createState() => _OnlineTvCollectionPageState();
}

class _OnlineTvCollectionPageState extends State<OnlineTvCollectionPage>
  ...
  void addAllListData() {
    ...
    listViews.add(CollectionWatchList(
      animation: Tween<double>(begin: 0.0, end: 1.0).animate(CurvedAnimation(
          parent: widget.animationController!,
